...
# enum_list = []
# [enum_list.append(f'index: {index}, {value} ') for index, value in
#  enumerate(data_read[main_db_name], start=0)]
...
#
#    print(data_read['main'][0]['name'])
#     for element in data_read['main']:
#                 print(type(element))
#                 print(element['name'])
